...
export default {
  ...
  moduleNameMapper: {
    ...
    '^@pocket/domain/(.*)$': '<rootDir>/projects/pocket/src/app/domain/$1',
    '^@pocket/application/(.*)$': '<rootDir>/projects/pocket/src/app/application/$1',
    '^@pocket/ui/(.*)$': '<rootDir>/projects/pocket/src/app/ui/$1',
    '^@pocket/infrastructure/(.*)$': '<rootDir>/projects/pocket/src/app/infrastructure/$1',
    '^@pocket/environments/(.*)$': '<rootDir>/projects/pocket/src/environments/$1',
    '^@pocket/config/(.*)$': '<rootDir>/projects/pocket/src/app/config/$1',
